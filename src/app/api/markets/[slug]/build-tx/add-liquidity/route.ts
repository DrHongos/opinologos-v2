...
import { buildAddLiquidityTxs, parseUsdcToWei, getChainId } from '@/lib/tx-builder';
...
export async function POST(
  ...
  return Response.json({
    transactions: buildAddLiquidityTxs(rows[0].os_index as `0x${string}`, amountWei),
    chainId: getChainId(),
    note: 'Deposits collateral as market liquidity. You receive LP tokens representing your share.',
  });
}
